                  ...
                  <div key={`products__${index}`} className="promo-block__thumb product-block">
                    ...
                    <div className="product-block__detail">
                      ...
                      <div className="product-block__actions">
                        <button className="btn--unstyled product-block__link" onClick={this.handleBasketClick}>
                        ...
                        <button className="btn--unstyled product-block__link" onClick={this.handleWishlistClick}>
