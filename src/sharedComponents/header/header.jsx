    ...
    return (
      <header className={styles.header}>
        <div className={styles.header__menu}>
          <button onClick={this.handleMenuClick} className="btn--unstyled">
        ...
        <a href="/" className={styles.logo}>
          <svg className={styles.logo__svg} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 328">
        ...
        <div className={styles.header__actions}>
          <button className={`btn--unstyled ${styles.header__user}`}>
            <img className={styles.header__userImg} src={userprofileImg} alt="user image" />
          </button>
        </div>
      </header>
    );
